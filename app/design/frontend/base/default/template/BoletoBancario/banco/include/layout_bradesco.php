...
O número do seu pedido é: <strong><?php echo $_POST["ref_transacao"] ?></strong>. Valor: R$ <?php echo $dadosboleto["valor_boleto"]?>.<br/>
<br />
...
</tr><tr><td valign=top width=7 height=1><img height=1 src=<?php echo $home_url . 'lib/boleto_php/imagens/2.png width=7 border=0>' ; ?></td><td valign=top width=659 height=1><img height=1 src=<?php echo $home_url . 'lib/boleto_php/imagens/2.png width=659 border=0>' ; ?></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct  width=7 height=12></td><td class=ct  width=564 >Demonstrativo</td><td class=ct  width=7 height=12></td><td class=ct  width=88 >Autenticação 
...
de pagamento</td><td class=ct valign=top width=7 height=13><img height=13 src=<?php echo $home_url . 'lib/boleto_php/imagens/1.png width=1 border=0>' ; ?></td><td class=ct valign=top width=180 height=13>Vencimento</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=<?php echo $home_url . 'lib/boleto_php/imagens/1.png width=1 border=0>' ; ?></td><td class=cp valign=top width=472 height=12>Pagável 
em qualquer Banco até o vencimento</td><td class=cp valign=top width=7 height=12><img height=12 src=<?php echo $home_url . 'lib/boleto_php/imagens/1.png width=1 border=0>' ; ?></td><td class=cp valign=top align=right width=180 height=12> 
  <span class="campo">
  <?php echo $dadosboleto["data_vencimento"]?>
  </span></td>
</tr><tr><td valign=top width=7 height=1><img height=1 src=<?php echo $home_url . 'lib/boleto_php/imagens/2.png width=7 border=0>' ; ?></td><td valign=top width=472 height=1><img height=1 src=<?php echo $home_url . 'lib/boleto_php/imagens/2.png width=472 border=0>' ; ?></td><td valign=top width=7 height=1><img height=1 src=<?php echo $home_url . 'lib/boleto_php/imagens/2.png width=7 border=0>' ; ?></td><td valign=top width=180 height=1><img height=1 src=<?php echo $home_url . 'lib/boleto_php/imagens/2.png width=180 border=0>' ; ?></td></tr></tbody></table><table cellspacing=0 cellpadding=0 border=0><tbody><tr><td class=ct valign=top width=7 height=13><img height=13 src=<?php echo $home_url . 'lib/boleto_php/imagens/1.png width=1 border=0>' ; ?></td><td class=ct valign=top width=472 height=13>Cedente</td><td class=ct valign=top width=7 height=13><img height=13 src=<?php echo $home_url . 'lib/boleto_php/imagens/1.png width=1 border=0>' ; ?></td><td class=ct valign=top width=180 height=13>Agência/Código 
...
documento</td><td class=ct valign=top width=7 height=13> <img height=13 src=<?php echo $home_url . 'lib/boleto_php/imagens/1.png width=1 border=0>' ; ?></td><td class=ct valign=top width=62 height=13>Espécie 
...
número</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=<?php echo $home_url . 'lib/boleto_php/imagens/1.png width=1 border=0>' ; ?></td><td class=cp valign=top  width=113 height=12><div align=left> 
  <span class="campo">
...
<img height=13 src=<?php echo $home_url . 'lib/boleto_php/imagens/1.png width=1 border=0>' ; ?></td><td class=ct valign=top width=53 height=13>Espécie</td><td class=ct valign=top height=13 width=7> 
...
Outras deduções</td></tr><tr><td class=cp valign=top width=7 height=12> <img height=12 src=<?php echo $home_url . 'lib/boleto_php/imagens/1.png width=1 border=0>' ; ?></td><td class=cp valign=top align=right width=180 height=12></td></tr><tr><td valign=top width=7 height=1><img height=1 src=<?php echo $home_url . 'lib/boleto_php/imagens/2.png width=7 border=0>' ; ?></td><td valign=top width=180 height=1><img height=1 src=<?php echo $home_url . 'lib/boleto_php/imagens/2.png width=180 border=0>' ; ?></td></tr></tbody></table></td></tr><tr><td align=right width=10> 
