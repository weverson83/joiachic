...
class MGS_Deals_Adminhtml_DealsController extends Mage_Adminhtml_Controller_Action
{

	protected function _initAction() {
		$this->loadLayout()
			->_setActiveMenu('mgscore/deals/items')
	...
	public function indexAction() {
		...
		$this->_title($this->__('Deals'))
             ->_title($this->__('Deals Report'));
		$this->_initAction();
		$this->_addContent($this->getLayout()->createBlock('deals/adminhtml_deals'));
		$this->renderLayout();
	}
	...
	public function editAction() {
		...
		if ($model->getId() || $id == 0) {
			...
			$this->loadLayout();
			$this->_setActiveMenu('mgscore/deals/items');
            ...
            try {
                ...
                Mage::getSingleton('adminhtml/session')->addSuccess(
                    Mage::helper('adminhtml')->__(
                        'Total of %d record(s) were successfully deleted', count($dealsIds)
                    )
                );
            } catch (Exception $e) {
                Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
    ...
    {
        $fileName   = 'deals.csv';
        $content    = $this->getLayout()->createBlock('deals/adminhtml_deals_grid')
            ->getCsv();
