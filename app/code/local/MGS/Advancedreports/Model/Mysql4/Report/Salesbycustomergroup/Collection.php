...
class MGS_Advancedreports_Model_Mysql4_Report_Salesbycustomergroup_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    ...
    public function __construct() {
        ...
        $this->_resource = Mage::getResourceModel('advancedreports/salesbycustomergroup')->init('advancedreports/salesbycustomergroup');
     ...
     *
     * @return MGS_Advancedreports_Model_Mysql4_Report_Order_Collection
     */
    ...
    protected function _initSelect() {
        ...
        if (!$this->isTotals()) {
            ...
            $this->getSelect()->group('customer_group_id');
        }
        return $this;
    }
     ...
     * @return boolean|MGS_Advancedreports_Model_Mysql4_Report_Order_Collection
     */
