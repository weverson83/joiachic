...
class MGS_Advancedreports_Model_Mysql4_Report_Salesbyhour_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
     ...
     *
     * @return MGS_Advancedreports_Model_Mysql4_Report_Salesbyhour_Collection
     */
    protected function _getSelectedColumns() {
        ...
        if ($this->isTotals()) {
            ...
            $this->_selectedColumns = array(
                'hour' => 'CONCAT(h, ":00")',
                'total_item_count' => 'IFNULL(total_item_count, 0)',
    ...
    protected function _initSelect() {
        ...
        if (!$this->isTotals()) {
            //$this->getSelect()->joinRight('advancedreports_hour', 'HOUR(sales_flat_order.created_at) = advancedreports_hour.h', array('h'));            
            $this->getSelect()->group('h');
        }
        return $this;
    }
     ...
     * @return boolean|MGS_Advancedreports_Model_Mysql4_Report_Salesbyhour_Collection
     */
