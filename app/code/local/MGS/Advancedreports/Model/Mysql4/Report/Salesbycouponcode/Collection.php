...
class MGS_Advancedreports_Model_Mysql4_Report_Salesbycouponcode_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    ...
    public function __construct() {
        ...
        $this->_resource = Mage::getResourceModel('advancedreports/salesbycouponcode')->init('advancedreports/salesbycouponcode');
     ...
     *
     * @return MGS_Advancedreports_Model_Mysql4_Report_Salesbycouponcode_Collection
     */
    protected function _getSelectedColumns() {
        ...
        if ($this->isTotals()) {
            ...
            $this->_selectedColumns = array(
                ...
                'total_qty_ordered' => 'IFNULL(SUM(total_qty_ordered), 0)',
                'subtotal' => 'IFNULL(SUM(subtotal), 0)',
                'tax_amount' => 'IFNULL(SUM(tax_amount), 0)',
                'shipping_amount' => 'IFNULL(SUM(shipping_amount), 0)',
                'discount_amount' => 'IFNULL(SUM(discount_amount), 0)',
                'grand_total' => 'IFNULL(SUM(grand_total), 0)',
                'total_invoiced' => 'IFNULL(SUM(total_invoiced), 0)',
                'base_total_refunded' => 'IFNULL(SUM(base_total_refunded), 0)'
            );
        }
    ...
    protected function _initSelect() {
        ...
        if (!$this->isTotals()) {
            ...
            $this->getSelect()->group('coupon_code');
        }
        return $this;
    }
     ...
     * @return boolean|MGS_Advancedreports_Model_Mysql4_Report_Salesbycouponcode_Collection
     */
