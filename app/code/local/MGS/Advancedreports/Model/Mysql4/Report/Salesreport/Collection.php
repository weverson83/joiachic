...
class MGS_Advancedreports_Model_Mysql4_Report_Salesreport_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    ...
    public function __construct() {
        ...
        $this->_resource = Mage::getResourceModel('advancedreports/salesreport')->init('advancedreports/salesreport');
     ...
     *
     * @return MGS_Advancedreports_Model_Mysql4_Report_Salesreport_Collection
     */
     ...
     * @return boolean|MGS_Advancedreports_Model_Mysql4_Report_Salesreport_Collection
     */
