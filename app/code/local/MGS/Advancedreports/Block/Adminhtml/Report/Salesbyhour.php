...
class MGS_Advancedreports_Block_Adminhtml_Report_Salesbyhour extends Mage_Adminhtml_Block_Widget_Grid_Container {
    ...
    public function __construct() {
        ...
        $this->setTemplate('mgs/advancedreports/report/salesbyhour/grid/container.phtml');
        parent::__construct();
