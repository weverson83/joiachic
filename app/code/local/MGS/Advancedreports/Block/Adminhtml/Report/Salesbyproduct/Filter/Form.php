...
class MGS_Advancedreports_Block_Adminhtml_Report_Salesbyproduct_Filter_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('sku', 'text', array(
            'label' => Mage::helper('advancedreports')->__('Search SKU'),
            'title' => Mage::helper('advancedreports')->__('Enter SKU for report'),
        ...
        $fieldset->addField('period_type', 'select', array(
            ...
            'label' => Mage::helper('reports')->__('Show By'),
            'title' => Mage::helper('reports')->__('Show By')
        ));
