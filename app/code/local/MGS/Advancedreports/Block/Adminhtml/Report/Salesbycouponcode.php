...
class MGS_Advancedreports_Block_Adminhtml_Report_Salesbycouponcode extends Mage_Adminhtml_Block_Widget_Grid_Container {

    public function __construct() {
        $this->_blockGroup = 'advancedreports';
        $this->_controller = 'adminhtml_report_salesbycouponcode';
        $this->_headerText = Mage::helper('advancedreports')->__('Sales by Coupon Code');
        $this->setTemplate('mgs/advancedreports/report/salesbycouponcode/grid/container.phtml');
        parent::__construct();
