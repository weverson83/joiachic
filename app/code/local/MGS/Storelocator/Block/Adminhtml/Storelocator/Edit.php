 ...
 */
class MGS_Storelocator_Block_Adminhtml_Storelocator_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
         ...
         *  the form tag in our case would be ‘mgs_storelocator/adminhtml_storelocator_edit_form’. 
         */
         ...
         */
        $this->_updateButton('save', 'label', Mage::helper('mgs_storelocator')->__('Save Store'));
        $this->_updateButton('delete', 'label', Mage::helper('mgs_storelocator')->__('Delete Store'));
    ...
    public function getHeaderText()
    {
        if (Mage::registry('storelocator_data')->getId()) {
            return Mage::helper('mgs_storelocator')->__("Edit Store '%s'", $this->escapeHtml(Mage::registry('storelocator_data')->getName()));
        }
        else {
            return Mage::helper('mgs_storelocator')->__('New Store');
        }
    }
