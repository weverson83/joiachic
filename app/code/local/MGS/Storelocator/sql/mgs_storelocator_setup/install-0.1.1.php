...
/**
 * Create table 'mgs_storelocator/storelocator'
 */
$table = $installer->getConnection()
    ->newTable($installer->getTable('mgs_storelocator/storelocator'))
   ...
   ->addColumn('description', Varien_Db_Ddl_Table::TYPE_TEXT, '64K', array(
    ...
    ->addColumn('trading_hours', Varien_Db_Ddl_Table::TYPE_TEXT, '64K', array(
        'nullable'  => true,
        'default'   => null,
        ), 'Trading Hours')
  ...
  ->addColumn('updated_at', Varien_Db_Ddl_Table::TYPE_TIMESTAMP, null, array(
    ...
    ->setComment('MGS Storelocator Table');
