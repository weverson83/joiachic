 ...
 */
class MGS_Storelocator_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
     ...
     * @var string
     */
    const XML_PATH_ENABLED = 'mgs_storelocator_general_setting/mgs_storelocator_status/enable';
     ...
     * @var string
     */
    const XML_PATH_DEFAULT_RADIUS = 'mgs_storelocator_general_setting/mgs_storelocator_display_setting/default_radius';
     ...
     * @var string
     */
    const XML_PATH_DEFAULT_ZOOM_LEVEl = 'mgs_storelocator_general_setting/mgs_storelocator_display_setting/zoom_level';
     ...
     * @var string
     */
    const XML_PATH_STORES_PER_PAGE = 'mgs_storelocator_general_setting/mgs_storelocator_display_setting/stores_per_page';
