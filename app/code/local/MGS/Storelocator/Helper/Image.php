 ...
 */
class MGS_Storelocator_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
     ...
     * @var string
     */
    const MEDIA_PATH    = 'mgs_storelocator';
    ...
    public function uploadImage($scope)
    {
        ...
        if ($adapter->isUploaded($scope)) {
            ...
            if (!$adapter->isValid($scope)) {
                Mage::throwException(Mage::helper('mgs_storelocator')->__('Uploaded image is not valid'));
            }
