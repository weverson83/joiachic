...
class AW_Blog_Block_Manage_Blog_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
		...
		if($image != ''){
			$form->getElement('image')->setValue('blog/images/' . $image);
		}
		
		$thumbnail = $form->getElement('featured_image')->getValue();
		if($thumbnail != ''){
			$form->getElement('featured_image')->setValue('blog/' . $thumbnail);
		}
