 ...
 */
class MageWorx_SeoMarkup_Model_Richsnippet_Catalog_Product_Meta_Weight extends MageWorx_SeoMarkup_Model_Richsnippet_Catalog_Product_Abstract
{
    protected function _addAttributeForNodes(simple_html_dom_node $node)
    {
        ...
        if ($weightValue) {
            $node->innertext = $node->innertext . '<meta itemprop="weight" content="'. $weightValue . '">' . "\n";
            return true;
        }
        return false;
    }
