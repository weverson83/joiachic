 ...
 */
class MageWorx_SeoMarkup_Model_Richsnippet_Catalog_Product_Meta_Color extends MageWorx_SeoMarkup_Model_Richsnippet_Catalog_Product_Abstract
{
    protected function _addAttributeForNodes(simple_html_dom_node $node)
    {
        $colorValue = Mage::helper('mageworx_seomarkup')->getColorValue($this->_product);
        if ($colorValue) {
