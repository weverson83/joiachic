 ...
 */
class MageWorx_SeoMarkup_Model_Richsnippet_Catalog_Product_Meta_Model extends MageWorx_SeoMarkup_Model_Richsnippet_Catalog_Product_Abstract
{
    protected function _addAttributeForNodes(simple_html_dom_node $node)
    {
        $modelValue = Mage::helper('mageworx_seomarkup')->getModelValue($this->_product);
        if ($modelValue) {
