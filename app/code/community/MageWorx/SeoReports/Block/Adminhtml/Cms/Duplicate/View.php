...
class MageWorx_SeoReports_Block_Adminhtml_Cms_Duplicate_View extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setChild('grid',
                $this->getLayout()->createBlock('seoreports/adminhtml_cms_duplicate_view_grid',
                        'seoreports.cms.duplicate.view.grid'));
