 ...
 */
class MageWorx_SeoXTemplates_Model_Converter_Product_Url extends MageWorx_SeoXTemplates_Model_Converter_Product
{
    ...
    protected function _render($convertValue)
    {
        ...
        return Mage::getSingleton('catalog/product_url')->formatUrlKey($convertValue);
    }
}