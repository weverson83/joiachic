 ...
 */
class MageWorx_SeoXTemplates_Model_Mysql4_Template_Relation_Product extends MageWorx_SeoXTemplates_Model_Mysql4_Template_Relation
{
    /**
     * Define main table
     *
    ...
    {
        $this->_init('mageworx_seoxtemplates/template_relation_product', 'id');
    }
