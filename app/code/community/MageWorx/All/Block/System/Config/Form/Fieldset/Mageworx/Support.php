...
class MageWorx_All_Block_System_Config_Form_Fieldset_Mageworx_Support extends MageWorx_All_Block_System_Config_Form_Fieldset_Mageworx_Abstract
{
    ...
    protected function _getReasons()
    {
        ...
        $modules = Mage::helper('mageworx_all/moduleList')->getModuleList();
        ...
        foreach ($modules as $moduleName => $moduleData) {
            ...
            $reasons[] = array(
                'label' => $this->__('%s Support (free)', $moduleData['extension_name'] . ' v' . $moduleData['version']),
                'value' => $moduleName . ' ' . $moduleData['version']
            );
        }
