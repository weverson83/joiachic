...
class AM_RevSlider_Block_Adminhtml_Slider_Edit_Tab_Main
    ...
    public function getTabLabel(){
        return '<i class="eg-icon-cog"></i>'.Mage::helper('revslider')->__('Information');
    }
    ...
    public function _prepareForm(){
        ...
        $layout_example = $fieldset->addField('layout_example', 'text', array(
            'label'     => Mage::helper('revslider')->__('Layout Example'),
            'title'     => Mage::helper('revslider')->__('Layout Example'),
            'note'      => Mage::helper('revslider')->__('Can be different based on theme style')
        ));
        $layout_example->setRenderer(
            $this->getLayout()->createBlock('revslider/adminhtml_widget_form_layout')
        );
        ...
        $layout4 = $fieldset->addField('fullscreen_offset_container', 'text', array(
            ...
            'label'     => Mage::helper('revslider')->__('Offset Containers'),
            'title'     => Mage::helper('revslider')->__('Offset Containers'),
            'note'      => Mage::helper('revslider')->__('Example: #header or .header, .footer, #somecontainer | The height of fullscreen slider will be decreased with the height of these Containers to fit perfect in the screen')
        ));
