...
class Trezo_Cielo_Model_Cielo extends Mage_Payment_Model_Method_Cc
{

    protected $_code = 'trezo_cielo';
    protected $_formBlockType = 'trezo_cielo/form';
    protected $_infoBlockType = 'trezo_cielo/info';
    ...
    {
        $enabledLog = Mage::getStoreConfig('payment/trezo_cielo/active_log');
        ...
        $webservice = Mage::getModel('trezo_cielo/webservice_cielo', array('numero' => Mage::getStoreConfig('payment/trezo_cielo/affiliationnumber'), 'chave' => Mage::getStoreConfig('payment/trezo_cielo/affiliationkey')));

        //Define os dados do webservice
        $webservice->setAmbiente(Mage::getStoreConfig('payment/trezo_cielo/environment'));
        $webservice->setProduto((($ccInstallments == 1) ? 1 : Mage::getStoreConfig('payment/trezo_cielo/installmenttype')));
        ...
        $transacao = Mage::getModel('trezo_cielo/webservice_transacao');
        ...
        $transacao->setProduto((($ccInstallments == 1) ? 1 : Mage::getStoreConfig('payment/trezo_cielo/installmenttype')));
        $transacao->setValor($payment->getOrder()->getGrandTotal() * 100);

        //Cria um novo cartão
        $cartao = Mage::getModel('trezo_cielo/webservice_cartao');
        ...
        $cliente = Mage::getModel('trezo_cielo/webservice_cliente', array('numero' => Mage::getStoreConfig('payment/trezo_cielo/affiliationnumber'), 'chave' => Mage::getStoreConfig('payment/trezo_cielo/affiliationkey')));
        $cliente->setAmbiente(Mage::getStoreConfig('payment/trezo_cielo/environment'));
        ...
        if ($enabledLog) {
            Mage::log($request, null, 'trezo-cielo-request.log', true);
            Mage::log($response, null, 'trezo-cielo-response.log', true);
        }
    ...
    public function getInstallments()
    {
        ...
        $maxPortions = (int) Mage::getStoreConfig('payment/trezo_cielo/maxinstallments');
        $minimumPortionAmount = (float) Mage::getStoreConfig('payment/trezo_cielo/mininstallmentsvalue');
