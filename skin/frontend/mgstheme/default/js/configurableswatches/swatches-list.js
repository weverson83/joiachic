...
var ConfigurableSwatchesList = {
    ...
    {
        var that = this;
        mgsjQuery('.configurable-swatch-list li').each(function() {
            that.initSwatch(this);
            var $swatch = mgsjQuery(this);
    ...
    handleSwatchSelect: function($swatch)
    {
        ...
        mgsjQuery.each(this.swatchesByProduct[productId], function(key, $productSwatch) {
...
mgsjQuery(document).on('configurable-media-images-init', function(){
