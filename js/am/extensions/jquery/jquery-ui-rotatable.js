(function($, undefined) {
    $.widget("ui.rotatable", $.ui.mouse, {
        ...
        angle: function(angle) {
            ...
            this.elementCurrentAngle = this.degToRad(this.options.angle);
        ...
        ui: function() {
            return {
                ...
                angle: {
                    start: this.radToDeg(this.elementStartAngle),
                    current: this.radToDeg(this.elementCurrentAngle),
                    stop: this.radToDeg(this.elementStopAngle)
                }
            };
        }
    });
