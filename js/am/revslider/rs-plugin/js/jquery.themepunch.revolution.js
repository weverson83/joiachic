...
********************************/
		...
		********************************************/
		...
		var swapSlide = function(container,opt) {
			...
			if (defimg.data('lazyload') !=undefined && defimg.data('lazyload') !="undefined" && defimg.data('lazydone') !=1 ) {
				...
				punchgs.TweenLite.set(container.find('.tp-loader'),{display:"block",opacity:0});
				punchgs.TweenLite.to(container.find('.tp-loader'),0.3,{autoAlpha:1});*/
		...
		var swapSlideCall = function(opt,defimg,container) {
		    ...
		    //punchgs.TweenLite.to(container.find('.tp-loader'),0.3,{autoAlpha:0});
		...
		********************************/
		...
		var swapSlideProgress = function(container,opt) {
			...
			var nextsh = nextli.find('.slotholder');
/*			punchgs.TweenLite.set(actli,{autoAlpha:1});
			punchgs.TweenLite.set(nextli,{autoAlpha:0});
...
/*			actli.css({'visibility':'visible'});
			...
			punchgs.TweenLite.set(actli,{'left':'0px','top':'0px'});
			punchgs.TweenLite.set(nextli,{'left':'0px','top':'0px'});
			...
			//////////////////////////////////////////////////////////////////
					...
					container.find('>li').each(function() {
						...
						if (li.index!=opt.act && li.index!=opt.next)
							punchgs.TweenLite.set(li,{zIndex:16});
					});
			...
			*/
			...
			if (nexttrans==0) {								// BOXSLIDE
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							punchgs.TweenLite.fromTo(ss,(masterspeed)/600,
												{opacity:0,top:(0-opt.sloth),left:(0-opt.slotw),rotation:opt.rotate},
												{opacity:1,transformPerspective:600,force3D:"auto",top:0,left:0,scale:1,rotation:0,delay:((j)*15 + (curz)*30)/1500, ease:punchgs.Power2.easeOut,onComplete:function() {
			...
			if (nexttrans==1) {
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							punchgs.TweenLite.fromTo(ss,rand/1000,
										{opacity:0, force3D:"auto",rotation:opt.rotate},
										{opacity:1, force3D:"auto",ease:punchgs.Power2.easeInOut,rotation:0,delay:rand2/1000})
			...
			if (nexttrans==2) {
						...
						actsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
									...
									punchgs.TweenLite.to(ss,masterspeed/1000,{left:opt.slotw, force3D:"auto",rotation:(0-opt.rotate),onComplete:function() {
															letItFree(container,opt,nextsh,actsh,nextli,actli)
						...
						nextsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
								...
								punchgs.TweenLite.fromTo(ss,masterspeed/1000,
												{left:0-opt.slotw, force3D:"auto",rotation:opt.rotate,transformPerspective:600},
												{left:0, rotation:0,ease:punchgs.Power2.easeOut,onComplete:function() {
															letItFree(container,opt,nextsh,actsh,nextli,actli)
														}
									});
			...
			if (nexttrans==3) {
						...
						actsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
									punchgs.TweenLite.to(ss,masterspeed/1000,{top:opt.sloth,rotation:opt.rotate,force3D:"auto",transformPerspective:600,onComplete:function() {
															letItFree(container,opt,nextsh,actsh,nextli,actli)
									}});
						...
						nextsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
								...
								punchgs.TweenLite.fromTo(ss,masterspeed/1000,
												{top:0-opt.sloth,rotation:opt.rotate,force3D:"auto",transformPerspective:600},
												{top:0,rotation:0,ease:punchgs.Power2.easeOut,onComplete:function() {
													letItFree(container,opt,nextsh,actsh,nextli,actli)
								}});
			...
			if (nexttrans==4 || nexttrans==5) {
						...
						actsh.find('.slotslide').each(function(i) {
							...
							punchgs.TweenLite.to(ss,cspeed*3,{transformPerspective:600,force3D:"auto",top:0+opt.height,opacity:0.5,rotation:opt.rotate,ease:punchgs.Power2.easeInOut,delay:del});
						});
						...
						nextsh.find('.slotslide').each(function(i) {
							...
							var del = (i*cspeed)/opt.slots;
							if (nexttrans==5) del = ((opt.slots-i-1)*cspeed)/(opt.slots)/1.5;
							punchgs.TweenLite.fromTo(ss,cspeed*3,
											{top:(0-opt.height),opacity:0.5,rotation:opt.rotate,force3D:"auto",transformPerspective:600},
											{top:0,opacity:1,rotation:0,ease:punchgs.Power2.easeInOut,delay:del,onComplete:function() {
													if (i==opt.slots-1) {
																letItFree(container,opt,nextsh,actsh,nextli,actli)
													}
							}});
			...
			if (nexttrans==6) {
						...
						actsh.find('.slotslide').each(function(i) {
							...
							punchgs.TweenLite.to(ss,(masterspeed+tempo)/1000,{top:0+opt.height,opacity:1,force3D:"auto",rotation:opt.rotate,transformPerspective:600,ease:punchgs.Power2.easeInOut});
						...
						nextsh.find('.slotslide').each(function(i) {
							...
							if (i<opt.slots/2)
								...
								var tempo = (2+opt.slots-i)*60;
									...
									punchgs.TweenLite.fromTo(ss,(masterspeed+tempo)/1000,
													{top:(0-opt.height),opacity:1,force3D:"auto",rotation:opt.rotate,transformPerspective:600},
													{top:(0),opacity:1,rotation:0,ease:punchgs.Power2.easeInOut,onComplete:function() {
			...
			if (nexttrans==9 || nexttrans==10) {
						...
						nextsh.find('.slotslide').each(function(i) {
							var ss=jQuery(this);
							ssamount++;
							punchgs.TweenLite.fromTo(ss,masterspeed/1000,{opacity:0,force3D:"auto",transformPerspective:600,left:0,top:0},{opacity:1,ease:punchgs.Power2.easeInOut,delay:(i*4)/1000});
			...
			if (nexttrans==11 || nexttrans==26) {
						...
						nextsh.find('.slotslide').each(function(i) {
							var ss=jQuery(this);
							punchgs.TweenLite.fromTo(ss,masterspeed/1000,{autoAlpha:0},{autoAlpha:1,force3D:"auto",ease:punchgs.Power2.easeInOut});
						});
			...
			if (nexttrans==12 || nexttrans==13 || nexttrans==14 || nexttrans==15) {
						...
						setTimeout(function() {
							...
							punchgs.TweenLite.set(nextsh.find('.defaultimg'),{autoAlpha:0});
						//punchgs.TweenLite.set(nextsh.find('.defaultimg'),{opacity:0});
					...
					//	kill();
						...
						punchgs.TweenLite.fromTo(ssn,speedy,
										{left:twx, top:twy, scale:fromscale, opacity:op,rotation:opt.rotate},
										{opacity:1,rotation:0,left:0,top:0,scale:1,ease:easeitin,force3D:"auto",onComplete:function() {
														letItFree(container,opt,nextsh,actsh,nextli,actli);
														punchgs.TweenLite.set(actli,{'position':'absolute','z-index':18});
						...
						if (specials!=1) {
								if (nexttrans==12)
									punchgs.TweenLite.to(ssa,speedy2,{'left':(0-oow)+'px',force3D:"auto",scale:scal,opacity:op,rotation:opt.rotate,ease:easeitout});
								else
								if (nexttrans==15)
									punchgs.TweenLite.to(ssa,speedy2,{'left':(oow)+'px',force3D:"auto",scale:scal,opacity:op,rotation:opt.rotate,ease:easeitout});
								else
								if (nexttrans==13)
									punchgs.TweenLite.to(ssa,speedy2,{'top':(0-ooh)+'px',force3D:"auto",scale:scal,opacity:op,rotation:opt.rotate,ease:easeitout});
								else
								if (nexttrans==14)
									punchgs.TweenLite.to(ssa,speedy2,{'top':(ooh)+'px',force3D:"auto",scale:scal,opacity:op,rotation:opt.rotate,ease:easeitout});
						}

						//punchgs.TweenLite.set(nextli,{autoAlpha:1});
			...
			if (nexttrans==16) {						// PAPERCUT
					...
					punchgs.TweenLite.fromTo(actli.find('.tp-half-one'),masterspeed/1000,
					                 {width:oow,height:ooh/2,position:'absolute',top:'0px',left:'0px',force3D:"auto",transformPerspective:600,transformOrigin:"center top"},
					                 {scale:sc1,rotation:ro1,y:(0-ooh-ooh/4),ease:punchgs.Power2.easeInOut});
					setTimeout(function() {
						punchgs.TweenLite.set(actli.find('.tp-half-one'),{overflow:'hidden'});
					},50);
					punchgs.TweenLite.fromTo(actli.find('.tp-half-one'),masterspeed/2000,{opacity:1,force3D:"auto",transformPerspective:600,transformOrigin:"center center"},{opacity:0,delay:masterspeed/2000});

					punchgs.TweenLite.fromTo(actli.find('.tp-half-two'),masterspeed/1000,
					                 {width:oow,height:ooh,overflow:'hidden',position:'absolute',top:ooh/2,left:'0px',force3D:"auto",transformPerspective:600,transformOrigin:"center bottom"},
					                 {scale:sc2,rotation:ro2,y:ooh+ooh/4,ease:punchgs.Power2.easeInOut});

					punchgs.TweenLite.fromTo(actli.find('.tp-half-two'),masterspeed/2000,{opacity:1,force3D:"auto",transformPerspective:600,transformOrigin:"center center"},{opacity:0,delay:masterspeed/2000});

					if (actli.html()!=null)
						punchgs.TweenLite.fromTo(nextli,(masterspeed-200)/1000,{opacity:0,scale:0.8,x:opt.width*xof, y:ooh*yof,rotation:ro3,force3D:"auto",transformPerspective:600,transformOrigin:"center center"},{rotation:0,scale:1,x:0,y:0,opacity:1,ease:punchgs.Power2.easeInOut,overwrite:"all"});
					...
					punchgs.TweenLite.set(nextli,{autoAlpa:1});
			...
			if (nexttrans==17) {								// 3D CURTAIN HORIZONTAL
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							punchgs.TweenLite.fromTo(ss,(masterspeed)/800,
											{opacity:0,rotationY:0,scale:0.9,rotationX:-110,force3D:"auto",transformPerspective:600,transformOrigin:"center center"},
											{opacity:1,top:0,left:0,scale:1,rotation:0,rotationX:0,force3D:"auto",rotationY:0,ease:punchgs.Power3.easeOut,delay:j*0.06,onComplete:function() {
			...
			if (nexttrans==18) {								// 3D CURTAIN VERTICAL
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							punchgs.TweenLite.fromTo(ss,(masterspeed)/500,
											{opacity:0,rotationY:310,scale:0.9,rotationX:10,force3D:"auto",transformPerspective:600,transformOrigin:"center center"},
											{opacity:1,top:0,left:0,scale:1,rotation:0,rotationX:0,force3D:"auto",rotationY:0,ease:punchgs.Power3.easeOut,delay:j*0.06,onComplete:function() {
													if (j==opt.slots-1)
														letItFree(container,opt,nextsh,actsh,nextli,actli)
											}});
			...
			if (nexttrans==19 || nexttrans==22) {								// IN CUBE
						...
						//if (nexttrans==129) {
							punchgs.TweenLite.fromTo(nextsh,masterspeed/2000,{force3D:"auto",transformPerspective:600,z:0,x:0,rotationY:0},{rotationY:1,ease:punchgs.Power1.easeInOut,z:-40});
							punchgs.TweenLite.fromTo(nextsh,masterspeed/2000,{force3D:"auto",transformPerspective:600,z:-40,rotationY:1},{rotationY:0,z:0,ease:punchgs.Power1.easeInOut,x:0,delay:3*(masterspeed/4000)});
							punchgs.TweenLite.fromTo(actsh,masterspeed/2000,{force3D:"auto",transformPerspective:600,z:0,x:0,rotationY:0},{rotationY:1,x:0,ease:punchgs.Power1.easeInOut,z:-40});
							punchgs.TweenLite.fromTo(actsh,masterspeed/2000,{force3D:"auto",transformPerspective:600,z:-40,x:0,rotationY:1},{rotationY:0,z:0,x:0,ease:punchgs.Power1.easeInOut,delay:3*(masterspeed/4000)});
						//}
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							punchgs.TweenLite.fromTo(ss,masterspeed/1000,
											{left:0,rotationY:opt.rotate,opacity:op,top:0,scale:0.8,force3D:"auto",transformPerspective:600,transformOrigin:torig,rotationX:rot},
											{left:0,rotationY:0,opacity:1,top:0,z:0, scale:1,force3D:"auto",rotationX:0, delay:(j*50)/1000,ease:punchgs.Power2.easeInOut,onComplete: function() {

																	if (j==opt.slots-1)
																		letItFree(container,opt,nextsh,actsh,nextli,actli)
															}
											});
							punchgs.TweenLite.to(ss,0.1,{opacity:1,delay:(j*50)/1000+masterspeed/3000});
						...
						actsh.find('.slotslide').each(function(j) {
							...
							punchgs.TweenLite.fromTo(ss,masterspeed/1000,
											{opacity:1,rotationY:0,top:0,z:0,scale:1,force3D:"auto",transformPerspective:600,transformOrigin:torig, rotationX:0},
											{opacity:1,rotationY:opt.rotate,top:0, scale:0.8,rotationX:rot, delay:(j*50)/1000,force3D:"auto",ease:punchgs.Power2.easeInOut,onComplete: function() {

																	if (j==opt.slots-1)
																		letItFree(container,opt,nextsh,actsh,nextli,actli)
															}
											});
							punchgs.TweenLite.to(ss,0.1,{opacity:0,force3D:"auto",delay:(j*50)/1000+(masterspeed/1000 - (masterspeed/10000))});
			...
			if (nexttrans==20 ) {								// FLYIN
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							punchgs.TweenLite.fromTo(ss,masterspeed/1500,
											{left:ofx,rotationX:40,z:-600, opacity:op,top:0,force3D:"auto",transformPerspective:600,transformOrigin:torig,rotationY:rot},
											{left:0, delay:(j*50)/1000,ease:punchgs.Power2.easeInOut});

							punchgs.TweenLite.fromTo(ss,masterspeed/1000,
											{rotationX:40,z:-600, opacity:op,top:0,scale:1,force3D:"auto",transformPerspective:600,transformOrigin:torig,rotationY:rot},
											{rotationX:0,opacity:1,top:0,z:0, scale:1,rotationY:0, delay:(j*50)/1000,ease:punchgs.Power2.easeInOut,onComplete: function() {

																	if (j==opt.slots-1)
																		letItFree(container,opt,nextsh,actsh,nextli,actli)
															}
											});
							punchgs.TweenLite.to(ss,0.1,{opacity:1,force3D:"auto",delay:(j*50)/1000+masterspeed/2000});
						...
						actsh.find('.slotslide').each(function(j) {
							...
							punchgs.TweenLite.fromTo(ss,masterspeed/1000,
											...
											{opacity:1,rotationX:40,top:0, z:-600, left:ofx, force3D:"auto",scale:0.8,rotationY:rot, delay:(j*50)/1000,ease:punchgs.Power2.easeInOut,onComplete: function() {

																if (j==opt.slots-1)
																	letItFree(container,opt,nextsh,actsh,nextli,actli)																	}
											});
							punchgs.TweenLite.to(ss,0.1,{force3D:"auto",opacity:0,delay:(j*50)/1000+(masterspeed/1000 - (masterspeed/10000))});
			...
			if (nexttrans==21 || nexttrans==25) {								// TURNOFF
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							punchgs.TweenLite.fromTo(ss,masterspeed/1500,
											{left:0,rotationX:rot2,z:0, opacity:0,top:0,scale:1,force3D:"auto",transformPerspective:600,transformOrigin:torig,rotationY:rot},
											{left:0,rotationX:0,top:0,z:0, scale:1,rotationY:0,force3D:"auto", delay:(j*100)/1000+masterspeed/10000,ease:punchgs.Power2.easeInOut,onComplete: function() {

																	if (j==opt.slots-1)
																		letItFree(container,opt,nextsh,actsh,nextli,actli)
															}
											});
							punchgs.TweenLite.to(ss,0.3,{force3D:"auto",opacity:1,delay:(j*100)/1000+(masterspeed*0.2)/2000+masterspeed/10000});
						...
						actsh.find('.slotslide').each(function(j) {
							...
							punchgs.TweenLite.fromTo(ss,masterspeed/3000,
											{left:0,rotationX:0,z:0, opacity:1,top:0,scale:1,force3D:"auto",transformPerspective:600,transformOrigin:torig,rotationY:0},
											{left:0,rotationX:rot2,top:0,z:0,force3D:"auto", scale:1,rotationY:rot, delay:(j*100)/1000,ease:punchgs.Power1.easeInOut});
							punchgs.TweenLite.to(ss,0.2,{force3D:"auto",opacity:0,delay:(j*50)/1000+(masterspeed/3000 - (masterspeed/10000))});
			...
			if (nexttrans==23 || nexttrans == 24) {								// cube-horizontal - inboxhorizontal
						...
						// ALL NEW SLOTS SHOULD BE SLIDED FROM THE LEFT TO THE RIGHT
						punchgs.TweenLite.fromTo(nextsh,masterspeed/2000,{force3D:"auto",transformPerspective:600,z:0,x:0,rotationY:0},{rotationY:1,ease:punchgs.Power1.easeInOut,z:-90});
						punchgs.TweenLite.fromTo(nextsh,masterspeed/2000,{force3D:"auto",transformPerspective:600,z:-90,rotationY:1},{rotationY:0,z:0,ease:punchgs.Power1.easeInOut,x:0,delay:3*(masterspeed/4000)});
						punchgs.TweenLite.fromTo(actsh,masterspeed/2000,{force3D:"auto",transformPerspective:600,z:0,x:0,rotationY:0},{rotationY:1,x:0,ease:punchgs.Power1.easeInOut,z:-90});
						punchgs.TweenLite.fromTo(actsh,masterspeed/2000,{force3D:"auto",transformPerspective:600,z:-90,x:0,rotationY:1},{rotationY:0,z:0,x:0,ease:punchgs.Power1.easeInOut,delay:3*(masterspeed/4000)});
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							punchgs.TweenLite.fromTo(ss,masterspeed/1000,
											...
											{left:0,rotationX:0,opacity:1,top:0,z:0, scale:1,rotationY:0, delay:(j*50)/1000,ease:punchgs.Power2.easeInOut,onComplete: function() {
							...
							punchgs.TweenLite.to(ss,0.1,{force3D:"auto",opacity:1,delay:(j*50)/1000+masterspeed/3000});
						...
						actsh.find('.slotslide').each(function(j) {
							var ss=jQuery(this);
							punchgs.TweenLite.fromTo(ss,masterspeed/1000,
											{left:0,opacity:1,rotationX:0,top:0,z:0,scale:1,force3D:"auto",transformPerspective:600,transformOrigin:torig, rotationY:0},
											{left:opx,opacity:1,rotationX:opt.rotate,top:0, scale:1,rotationY:rot, delay:(j*50)/1000,ease:punchgs.Power2.easeInOut,onComplete: function() {
